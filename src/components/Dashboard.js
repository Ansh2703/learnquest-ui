...
// A helper component for the "Your Progress" statistic cards
...
// A helper component for the "Continue Learning" course cards
...
function Dashboard({ user }) {
    ...
    return (
        <div className="space-y-10">
            ...
            {/* Upcoming Courses & Course Requests Section */}
            <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
                 ...
                 <div className="bg-gray-800 p-6 rounded-lg shadow-md">
                    ...
                    <button className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-semibold py-2 px-4 rounded-lg text-sm transition-colors">
                        Request a Course
                    </button>
                 </div>
            </section>
